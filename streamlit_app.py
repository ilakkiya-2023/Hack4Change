...
app_mode = st.sidebar.selectbox("Choose the app mode", ["Home", "Speech Recognition", "Community Discussion Forum", "Video Calling", "Learning Materials","Sign Language to text"])
